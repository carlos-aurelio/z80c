...
void z80_inc(struct z80 *z80, uint8_t *reg)
{
	uint8_t dst = *reg;
	uint8_t res = dst + 1;
...
void z80_inc_hl(struct z80 *z80)
{
...
void z80_inc_I_D(struct z80 *z80)
{
